    ...
    <div class="flex h-screen overflow-hidden">
            ...
            <div class="py-4 flex flex-col h-[calc(100%-4rem)]">
                ...
                <div class="px-3 space-y-1">
                    ...
                    <a href="/dashboard"
                        ...
                        <span class="ml-3 sidebar-text">Beranda</span>
                    </a>
                    ...
                    <!-- Products -->
                    <a href="/anggota"
                        class="sidebar-menu-item flex items-center h-10 px-3 rounded-md text-sm font-medium {{ request()->is('anggota') ? 'bg-sidebar-accent text-sidebar-accent-foreground' : 'hover:bg-sidebar-border/50' }} transition-colors"
                        aria-label="Products">
                        <i class="fas fa-user w-5 h-5"></i>
                        <span class="ml-3 sidebar-text">Anggota</span>
                    </a>

                    <!-- Categories -->
                    <a href="{{ route('loans.index') }}"
                        class="sidebar-menu-item flex items-center h-10 px-3 rounded-md text-sm font-medium {{ request()->is('loan') ? 'bg-sidebar-accent text-sidebar-accent-foreground' : 'hover:bg-sidebar-border/50' }} transition-colors"
        ...
        <div class="flex-1 overflow-auto">
            ...
            {{-- <footer
                ...
                <p>
                    Developed by <a href="https://web.facebook.com/urfavhak"
                        class="font-medium text-primary hover:underline" target="_blank"
                        rel="noopener noreferrer">XXXXXX</a>
                </p>
                <p class="mt-1">
