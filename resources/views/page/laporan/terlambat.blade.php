@extends('layouts.app')
@section('title', 'Pinjaman Terlambat')
@section('content')
    <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Laporan Buku Terlambat</h1>
                    <p class="text-gray-400">Kelola Laporan Perpustakaan</p>
                </div>
                <div class="flex gap-3">
                    <a href="{{ route('laporan.terlambat.excel') }}"
                    ...
                    <a href="{{ route('laporan.terlambat.pdf') }}"
                    ...
                    <table class="w-full">
                        <thead class="">
                            <tr class="bg-gray-900/70 text-gray-400 text-sm text-center font-medium">
                                ...
                                <th class="py-3 px-4">Hari Terlambat</th>
                            ...
                            @forelse ($loans as $loan)
                                @forelse ($loan->details as $item)
                                    @php
                                        ...
                                        $hariTerlambat = now()->greaterThan($batas) ? now()->diffInDays($batas) : 0;
                                    @endphp
                                    <tr class="hover:bg-gray-700/30 transition-colors duration-150 text-center text-sm">
                                        ...
                                        <td class="py-3 px-4 text-gray-200 font-medium"> {{ $item->book->judul }}</td>
                                        ...
                                        <td class="py-3 px-4 text-gray-200 font-medium">
                                            {{ abs($loan->telat_hari) }} hari</td>
                                        <td class="py-3 px-4 text-gray-200 font-medium">
                                            Rp.
                                            {{ number_format(abs($loan->denda), 0, ',', '.') }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="8" class="py-8 text-center text-gray-500">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="text-lg">Belum ada Buku Terlambat</p>
