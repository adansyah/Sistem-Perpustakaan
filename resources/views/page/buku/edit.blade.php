                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="induk" name="induk" value="{{ $data->induk }}" required
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="tgl_masuk" class="block text-sm font-medium text-gray-300 mb-1">tgl_masuk
                                    <span class="text-rose-400">*</span></label>
                                <input type="date" id="tgl_masuk" name="tgl_masuk" value="{{ $data->tgl_masuk }}"
                                    required
                                    class="w-full px-4 py-2.5 bg-gray-900/70 border border-gray-700/50 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all duration-200"
                            ...
                            <div>
                                ...
                                <select name="kategori" required
                                    ...
                                    <option value="dongeng"
                                        {{ old('kategori', $data->kategori) == 'dongeng' ? 'selected' : '' }}>Dongeng
                                    </option>
                                    <option value="cerpen"
                                        {{ old('kategori', $data->kategori) == 'cerpen' ? 'selected' : '' }}>Cerpen
                                    </option>
                                    <option value="novel"
                                        {{ old('kategori', $data->kategori) == 'novel' ? 'selected' : '' }}>Novel
                                    </option>
                                    <option value="komik"
                                        {{ old('kategori', $data->kategori) == 'komik' ? 'selected' : '' }}>Komik
                                    </option>
                                    <option value="lainnya"
                                        {{ old('kategori', $data->kategori) == 'lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
                            </div>
                            <div>
