...
@section('title', 'Input Data Pinjaman')
    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Input Data Pinjaman</h1>
                    <p class="text-gray-400">Tambahkan Data Pinjaman ke dalam sistem</p>
                </div>
            ...
            <div
                ...
                <form action="{{ route('loans.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                    @csrf
                    ...
                    <div class="grid  gap-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select name="anggota_id" class="w-full p-3 rounded bg-gray-800 text-white mb-4" required>
                            ...
                            <div>
                                <label for="tanggal_kembali"
                                    class="block text-sm font-medium text-gray-300 mb-1">tanggal_kembali <span
                                        class="text-rose-400">*</span></label>
